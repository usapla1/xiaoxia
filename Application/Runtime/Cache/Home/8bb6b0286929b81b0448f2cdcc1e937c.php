...
<div class="login_wrapper">
	...
	<div class="login_box">
		<form id="loginForm" action="<?php echo U('Register/register');?>" method="post">
			...
			<input type="password" id="password1" name="repassword" tabindex="3" placeholder="请确认密码" />
			<input type="text" id="name" name="username" tabindex="5" placeholder="请输入自己的真实姓名" />
			<input type="text" id="telphone" name="telphone" tabindex="6" placeholder="请输入手机号码" />
			<input type="text" id="user_date" name="user_date"  placeholder="请输入出生年月如1990/11/09"/>
