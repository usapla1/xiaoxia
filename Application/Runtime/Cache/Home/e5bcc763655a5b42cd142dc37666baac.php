...
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		<a class="logo" href="h/">
    			<img width="229" height="43" alt="新安招聘" src="images/logo.png">
    		</a>
        	...
        	<dl class="collapsible_menu">
                ...
                <dd class="btm" style="display: none;"><a href="enterprise.html">我的公司主页</a></dd>
        ...
        <dl class="c_section">
            ...
            <dd id="pad">
                <ul class="user_noModify">
                    <li>用户名：<span>xinan</span> </li>
                    <li>邮箱地址：<span>xinan@qq.com</span> </li>
                    <li>手机号码：<span>12345678901</span> </li>
                    <li>出生日期：<span>2016/01/01</span> </li>
                    <li>登录密码：<span>********</span>    <a href="updatePwd.html" alt="修改密码">修改密码</a> </li>
                </ul>
                <dl class="user_thirdLogin">
                    <dt><img alt="qq" src="images/qq.png"></dt>
                                        	<dd>已绑定QQ帐号  <span>xinan</span>
                    	 	<a id="cancelBind" href="javascript:;">解除绑定</a>
                    	 </dd>
                	                </dl>
				<dl class="user_thirdLogin">
                    <dt><img alt="weibo" src="images/weibo.png"></dt>
