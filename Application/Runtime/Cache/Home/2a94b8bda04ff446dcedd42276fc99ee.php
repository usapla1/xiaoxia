	...
	<div id="container">
		<div id="sidebar">
			...
			<div class="mainNavs">
				<div class="menu_box">
					<div class="menu_main">
						<a class="sidebarHref" href="http://127.0.0.1/newfish/index.php/Home/Register" title="快速注册"><h2>快速注册<span></span></h2></a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<a class="sidebarHref" href="http://127.0.0.1/newfish/index.php/Home/Login" title="个人用户登录"><h2>个人用户登录<span></span></h2></a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<a class="sidebarHref" href="http://127.0.0.1/newfish/index.php/Home/Login" title="企业用户登陆"><h2>企业用户登陆<span></span></h2></a>
					</div>
				</div>
			</div>
		</div>
		<div class="content">
			...
			<dl class="company_center_content">
                <dt>
                    <h1><em></em>最新职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"><?php echo ($count); ?></i>个）</span></h1>
                </dt>
                <dd>
