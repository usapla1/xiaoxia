...
<div class="content">
    <dl class="company_center_content">
        <dt>
            <h1><em></em>申请记录 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"><?php echo ($count); ?></i>个）</span></h1>
        </dt>
        <dd>
            <form id="searchForm">
			    ...
			    <ul class="reset my_jobs">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li data-id="149594">
		                <h3><a target="_blank" title="前端开发工程师" href="positionDetail.html?pid=i"><?php echo ($vo["work_title"]); ?></a></h3>
		                <span class="receivedResumeNo">
							是否查看:<?php if($vo["is_look"] == 1 ): ?>已查看
							<?php else: ?> <strong>未查看</strong><?php endif; ?>


						</span>
		                <div class="c9">投递时间： <?php echo ($vo["create_time"]); ?></div>
						<div class="links">
							<a class="job_refresh" href="javascript:location.reload()">刷新<span>每个职位7天内只能刷新一次</span></a>
							<a target="_blank" class="job_edit" href="http://127.0.0.1/newfish/index.php/Home/Work/show/workid/<?php echo ($vo["workid"]); ?>">查看详情</a>
							<a class="job_del" href="http://127.0.0.1/newfish/index.php/Home/User/apdel/seekid/<?php echo ($vo["seekid"]); ?>">删除</a>
		                </div>
